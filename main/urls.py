...
from .views import index, BBLoginView, profile, BBLogoutView, ChangeUserInfoView, BBPaswordChangeView, RegisterDoneView, \
        RegisterUserView, user_activate, DeleteUserView, by_rubric, detail,\
